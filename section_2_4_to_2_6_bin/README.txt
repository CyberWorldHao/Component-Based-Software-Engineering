...
1. The zip file you downloaded contains this README file and the binary code for the examples in Sections 2.4 to 2.6 of the book.
...
2. To execute the binary, unzip the contents of the zip file into a local folder on your machine. The folder would contain the following files
	- AgeCalculator02.jar
	- AgeCalculatorApp02.jar
	- AgeCalculatorGlue.jar
...
4. From the OS console window command prompt, navigate to the folder where contents of the downloaded zip file were extracted to. 

5. Type the command 'java -cp .;./* codabook.agecalculator.glue.AgeCalculatorGlue' to start execution of the program.
