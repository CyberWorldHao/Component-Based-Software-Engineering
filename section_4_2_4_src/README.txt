...
1. The zip file you downloaded contains this README file and the source code for the example in Section 4.2.4. of the book.(in Eclipse project format).
...
4. After scanning the archive, Eclipse lists the following projects under ‘Projects’ selection box:
	...
	- VirtualStore.PromotionalShoppingCart
        
5. Select all the projects listed above and click on the 'Finish' button.
