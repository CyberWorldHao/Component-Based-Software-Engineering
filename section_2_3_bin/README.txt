...
1. The zip file you downloaded contains this README file and the binary code for the example in Section 2.3. of the book.

2. To execute the binary, unzip the contents of the zip file into a local folder on your machine. The folder would contain following files :
	-AgeCalculator01.jar
	-AgeCalculatorApp01.jar
	-README.txt 
...
5. Type the command 'java -jar AgeCalculatorApp01.jar' to start execution of the program.
