...
1. The zip file you downloaded contains this README file and the binary code for the example in Section 2.7. of the book.
...
2. To execute the binary, unzip the contents of the zip file into a local folder on your machine. The folder would contain the following files :
	- AgeCalculator03.jar
	- AgeCalculatorApp03.jar
	- AgeCalculatorIfce.jar
	- ComponentModel.jar
	- ComponentRunner.jar
	- README.txt
...
5. Type the command 'java -cp .;./* codabook.componentrunner.ComponentRunner codabook.agecalculator.app.AgeCalculatorApp' to start execution of the program which would present a text based menu.

6. Use the Age Calculator program as guided by the text based menu. 
