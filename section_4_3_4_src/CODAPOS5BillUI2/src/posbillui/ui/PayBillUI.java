...
import posbillui.controllers.PayBillCtrlr;
...
System.out
	...
	public void printBill(Bill bill, Gratuity gratuity) {
		...
		if (gratuity != null) {
			totalString += center("Gratuity: ", 7);
			totalString += formatNumber(gratuity.getGratuityAmount(), 7);
		}
