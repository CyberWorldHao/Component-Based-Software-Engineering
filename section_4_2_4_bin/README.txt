...
1. The zip file you downloaded contains this README file and the binary code for the example in Section 4.2.4. of the book.

2. To execute the binary, unzip the contents of the zip file into a local folder on your machine. The folder would contain the following files :
	- Application.jar
	- Base.jar	
	- ComponentModel.jar
	- ComponentRunner.jar
	- Inventory.jar
	- PromotionalShoppingCart.jar
	- README.txt


3. The program can be run from your OS console window provided Java Runtime Environment is installed and configured. 

4. From the command prompt, navigate to the folder where contents of the downloaded zip file were extracted to. 

5. Type the command 'java -cp .;./* codabook.componentrunner.ComponentRunner codabook.virtualstore.application.UI' to start execution of the program which would present a text based menu.

6. Use the Virtual Store program as guided by the text based menu titled 'Welcome to eStore'. 
