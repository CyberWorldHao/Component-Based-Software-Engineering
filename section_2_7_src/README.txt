...
1. The zip file you downloaded contains this README file and the source code for the example in Section 2.7. of the book (in Eclipse project format).
...
6. All of the above mentioned projects will get added to your Eclipse workspace.
...
4. There in the 'Program Arguments' text box ,write 'codabook.agecalculator.app.AgeCalculatorApp'.This is the name of the main file of the application you want to execute.

5. Now navigate to the 'Classpath' tab in the same dialog and select 'User Entries' from the classpath list box.

6. Click on 'add external jar' which will provide you with a jar selection dialog.Select the jar files present in the 'ComponentRunner' project we had added in 'Building Components' section above.

7. Click on 'Run' after completing the above steps.

8. Use the Age Calculator program as guided by the text based menu.
