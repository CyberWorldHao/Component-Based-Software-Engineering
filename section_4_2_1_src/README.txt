...
1. The zip file you downloaded contains this README file and the source code for the example in Section 4.2.1. of the book (in Eclipse project format).
...
4. Eclipse scans the zip file and displays 'VirtualStore' as a project available for import.

5. Select 'VirtualStore' project and click on the 'Finish' button.

6. VirtualStore project gets added to your Eclipse workspace.


Executing the Application
-------------------------

1. Right click on the project 'VirtualStore' under 'Project Explorer' window in Eclipse.

2. From the context pop-up menu, select 'Run as -> Java Application' option.

3. Use the Virtual Store program as guided by the text based menu titled 'Welcome to eStore'.
